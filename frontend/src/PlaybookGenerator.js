...
import { strategyMatcher, StrategyMatcher } from './utils/strategyMatcher';
        ...
        {dashboardMode === 'input' ? (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8">
              ...
              {currentStep === 1 && (
                <div>
                  <div className="text-sm uppercase text-muted-foreground tracking-wide mb-2">Step 1 of 10</div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        min="0"
                        max="100"
                        value={w2Draft || formData.w2IncomePercent}
                        onChange={(e) => {
                          const inputValue = e.target.value;
                          setW2Draft(inputValue); // Update draft immediately for display
                        }}
                        onBlur={(e) => {
                          const inputValue = e.target.value;
                          ...
                          // Update both fields
                          updateIncomeSplit(clampedW2, businessPercent);
                        }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="0"
                        max="100"
                        value={businessDraft || formData.businessIncomePercent}
                        onChange={(e) => {
                          const inputValue = e.target.value;
                          setBusinessDraft(inputValue); // Update draft immediately for display
                        }}
                        onBlur={(e) => {
                          const inputValue = e.target.value;
                          ...
                          // Update both fields
                          updateIncomeSplit(w2Percent, clampedBusiness);
                        }}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500"
                        placeholder="e.g., 40"
                      />
                    ...
                    <div className={`p-4 rounded-lg ${
                      (() => {
                        const w2Val = parseInt(w2Draft || formData.w2IncomePercent || '0');
                        const bizVal = parseInt(businessDraft || formData.businessIncomePercent || '0');
                        const total = w2Val + bizVal;
                        return total === 100 && w2Draft && businessDraft
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        {(() => {
                          ...
                          const bizVal = parseInt(businessDraft || formData.businessIncomePercent || '0');
                          const total = w2Val + bizVal;
                          const hasValues = (w2Draft || formData.w2IncomePercent) && (businessDraft || formData.businessIncomePercent);
                          
                          if (total === 100 && hasValues) {
                            return <span className="text-emerald-600 ml-2 font-semibold">✓ Perfect!</span>;
                          } else if (hasValues && total !== 100) {
                            return <span className="text-red-600 ml-2">Must equal 100%</span>;
                          }
                          return null;
                        })()}
                      </p>
              ...
              {currentStep === 4 && (
                <div>
                  <div className="text-sm uppercase text-gray-600 tracking-wide mb-2">Step 4 of 10</div>
              ...
              {currentStep === 5 && (formData.incomeType === 'business-owner' || formData.incomeType === 'blended') && (
                <div>
                  <div className="text-sm uppercase text-gray-600 tracking-wide mb-2">Step 5 of 10</div>
              ...
              {currentStep === 6 && (
                <div>
                  <div className="text-sm uppercase text-gray-600 tracking-wide mb-2">Step 6 of 10</div>
              ...
              {currentStep === 8 && formData.receivesStockComp && (
                <div>
                  <div className="text-sm uppercase text-gray-600 tracking-wide mb-2">Step 8 of 10</div>
              ...
              {currentStep === 9 && (
                <div>
                  <div className="text-sm uppercase text-gray-600 tracking-wide mb-2">Step 9 of 10</div>
